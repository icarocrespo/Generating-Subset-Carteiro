...
class Carteiro16(Experimento):
    ...
    def __init__(self, args):
        ...
        # configurações de plotagem upper bound g(x)
        self.gn1_constante = 0.6
        self.gn1_legenda = "g(n)=n.logn, c=0.6".format(self.gn1_constante)

        # configurações de plotagem lower bound g(x)
        self.gn2_constante = 0.9
        self.gn2_legenda = "g(n)=n.logn, c=0.9".format(self.gn2_constante)
    ...
    def executa_aproximacao(self):
        # realiza aproximação
        parametros, pcov = opt.curve_fit(funcao_log, xdata=self.tamanhos, ydata=self.medias)
        self.aproximados = [funcao_log(x, *parametros) for x in self.tamanhos_aproximados ]
...
class Carteiro82(Experimento):
    ...
    def __init__(self, args):
        ...
        # configurações de plotagem upper bound g(x)
        self.gn1_constante = 0.3
        self.gn1_legenda = "g(n)=n!, c=0.3".format(self.gn1_constante)

        # configurações de plotagem lower bound g(x)
        self.gn2_constante = 0.9
        self.gn2_legenda = "g(n)=n!, c=0.9".format(self.gn2_constante)
...
class Carteiro41(Experimento):
    ...
    def __init__(self, args):
        ...
        #configurações de plotagem upper bound g(x)
        self.gn1_constante = 0.12
        self.gn1_legenda = "g(n)=n.logn, c=0.12".format(self.gn1_constante)

        #configurações de plotagem lower bound g(x)
        self.gn2_constante = 0.15
        self.gn2_legenda = "g(n)=n.logn, c=0.15".format(self.gn2_constante)
