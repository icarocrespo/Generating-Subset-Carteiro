...
class ProblemaCarteiro16(Experimento):

    def __init__(self, args):
        super().__init__(args)
        self.id = "t"
        self.script = "scripts/ProblemaCarteiro16.py"
        self.output = "outputs/ProblemaCarteiro16.txt"

        # configurações de plotagem
        self.medicao_legenda = "Problema Carteiro Medido"
        self.medicao_cor_rgb = mapa_escalar.to_rgba(0)
        self.medicao_formato = formatos[1]

        self.aproximacao_legenda = "Problema Carteiro Aproximado"
        self.aproximacao_cor_rgb = mapa_escalar.to_rgba(1)
...
class ProblemaCarteiro41(Experimento):
    ...
    def __init__(self, args):
        super().__init__(args)
        self.id = "t"
        self.script = "scripts/ProblemaCarteiro41.py"
        self.output = "outputs/ProblemaCarteiro41.txt"
...
class ProblemaCarteiro82(Experimento):

    def __init__(self, args):
        super().__init__(args)
        self.id = "t"
        self.script = "scripts/ProblemaCarteiro82.py"
        self.output = "outputs/ProblemaCarteiro82.txt"
...
class ProblemaCarteiroTempo1(Experimento):

    def __init__(self, args):
        super().__init__(args)
        self.id = "t"
        self.script = "scripts/ProblemaCarteiroTempo1.py"
        self.output = "outputs/ProblemaCarteiroTempo1.txt"
...
class ProblemaCarteiroTempo10(Experimento):

    def __init__(self, args):
        super().__init__(args)
        self.id = "t"
        self.script = "scripts/ProblemaCarteiroTempo10.py"
        self.output = "outputs/ProblemaCarteiroTempo10.txt"
...
class ProblemaCarteiroTempo5(Experimento):

    def __init__(self, args):
        super().__init__(args)
        self.id = "t"
        self.script = "scripts/ProblemaCarteiroTempo5.py"
        self.output = "outputs/ProblemaCarteiroTempo5.txt"
...
class ProblemaCarteiroAlfa3(Experimento):

    def __init__(self, args):
        super().__init__(args)
        self.id = "t"
        self.script = "scripts/ProblemaCarteiroAlfa3.py"
        self.output = "outputs/ProblemaCarteiroAlfa3.txt"
...
class ProblemaCarteiroAlfa5(Experimento):

    def __init__(self, args):
        super().__init__(args)
        self.id = "t"
        self.script = "scripts/ProblemaCarteiroAlfa5.py"
        self.output = "outputs/ProblemaCarteiroAlfa5.txt"
...
class ProblemaCarteiroAlfa9(Experimento):

    def __init__(self, args):
        super().__init__(args)
        self.id = "t"
        self.script = "scripts/ProblemaCarteiroAlfa9.py"
        self.output = "outputs/ProblemaCarteiroAlfa9.txt"
...
def main():
    ...
    help_msg = "algoritmos (t=tsp naive, s=selection sort) ou nenhum para executar todos.  Padrão:{}".format(
        DEFAULT_ALGORITMOS)
    ...
    experimentos = [ProblemaCarteiro16(args), ProblemaCarteiro41(args), ProblemaCarteiro82(args),
                    ProblemaCarteiroTempo1(args), ProblemaCarteiroTempo5(args),
                    ProblemaCarteiroTempo10(args), ProblemaCarteiroAlfa3(args), ProblemaCarteiroAlfa5(args),
                    ProblemaCarteiroAlfa9(args)]
